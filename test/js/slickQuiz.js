...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Kontrollera mitt svar',
                nextQuestionText: 'Nästa &raquo;',
                backButtonText: '',
                completeQuizText: '',
                tryAgainText: '',
                questionCountText: 'Fråga %current av %total',
                preventUnansweredText: 'Du måste välja minst ett svar.',
